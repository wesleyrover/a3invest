...
function webViewerUpdateViewarea(evt) {
  ...
  if( window.getUrlParameterByName('errorMessage').indexOf('blob:') !== -1 && PDFViewerApplication.appConfig.toolbar.viewBookmark.href.indexOf('blob:') !== -1 )  {
    let blobFile = window.getUrlParameterByName('errorMessage');
    GetFileObjectFromURL(blobFile, function (fileObject) {
      fileTobase(fileObject).then( dataBase64 => { PDFViewerApplication.appConfig.toolbar.viewBookmark.href = dataBase64;});
    });
  } else{
    PDFViewerApplication.appConfig.toolbar.viewBookmark.href = href;
  }
...
async function fileTobase(fileObject) {
...
var GetFileObjectFromURL = function(filePathOrUrl, convertBlob) {
 GetFileBlobUsingURL(filePathOrUrl, function (blob) {
    convertBlob(blobToFile(blob, 'documento.jpg'));
 });
};
